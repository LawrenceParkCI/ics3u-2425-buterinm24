package unit3;
/**
 * Description: This program prints a work sheet about methods.
...
public class Methods {
	...
	public static void main(String[] args) {
		...
		System.out.println("This school year is very challenging.");
		...
		int myNum = 30;
		myNum = doubleNumber(myNum); //Passing value of myNum to the doubleNumber method
		//Inside the method, myNum is doubled and then returned to the main method
		System.out.println(myNum); //Printing out new value of myNum

		//Explain what is happening
		System.out.println(doubleNumber(5)); //Passing the value 5 to doubleNumber method
		//5 is doubled which returns 10, and 10 is printed out.


		//Part 3 is at the bottom, and return here to print out your method's return value
		int getNum1 = 1;
		int getNum2 = 3;
		System.out.println(larger(getNum1, getNum2));
	}
	 ...
	 */
	/**
	 * This method takes two integers and returns 
	 * the larger one
	 * @param num1 - first integer
	 * @param num2 - second integer
	 * @return int - the larger integer of the 2 that were passed to the method
	 */
	public static int larger(int num1, int num2) {
		int returnValue = Math.max(num1, num2);
		return returnValue;
	}
}