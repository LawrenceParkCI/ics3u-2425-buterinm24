...
public class TaskTrack {
	...
	public static void main(String[] args) {
		...
		//
			...
			c.print("Ok, please enter the number of the task you would like to complete: ");
			completedTaskNumber = c.readInt();
			isComplete[taskCount] = completeTask(completedTaskNumber);
	 ...
	 * @return
	 */
	public static boolean completeTask (int completedTaskNumber) {
